...
public abstract class BeanDefinitionReaderUtils {
	...
	public static void registerBeanDefinition(
		...
		/**
		 * 最重要的就是这一句！！ 这里调用的是GenericApplicationContext类的registerBeanDefinition方法
		 * 	方法核心：this.beanFactory.registerBeanDefinition(beanName, beanDefinition);
		 * 	这里的beanFactory就是 DefaultListableBeanFactory 而这个工厂就是spring里面最核心的东西 Bean工厂
		 * 	registerBeanDefinition()核心代码：this.beanDefinitionMap.put(beanName, beanDefinition);
		 * 									 this.beanDefinitionNames.add(beanName);
		 * 	最终是把bd放到了DefaultListableBeanFactory的beanDefinitionMap中（Map结构是ConcurrentHashMap）
